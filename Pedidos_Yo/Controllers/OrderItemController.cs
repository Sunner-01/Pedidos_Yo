...
namespace Pedidos_Yo.Controllers
{
    public class OrderItemController : Controller
    {
        ...
        public OrderItemController(Pedidos_YoDBContext context)
        {
            _context = context;
        }
        ...
        {
            var pedidos_YoDBContext = _context.OrderItems.Include(o => o.Order).Include(o => o.Product);
        ...
        {
            ViewData["OrderId"] = new SelectList(_context.Orders, "Id", "Estado");
        ...
        public async Task<IActionResult> Create([Bind("Id,OrderId,ProductId,Cantidad,Subtotal")] OrderItemModel orderItemModel)
        {
            ...
            ViewData["OrderId"] = new SelectList(_context.Orders, "Id", "Estado", orderItemModel.OrderId);
